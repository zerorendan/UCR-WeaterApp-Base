...
import cr.ac.ucr.weather.core.utils.HourConverter
import cr.ac.ucr.weather.core.utils.WeatherType
import cr.ac.ucr.weather.domain.model.ForecastWeatherModel


@Composable
fun ForecastLazyRow(forecasts: List<ForecastWeatherModel>) {
    LazyRow(
